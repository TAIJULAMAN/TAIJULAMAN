...
[![Next.js, Node.js, JavaScript, TypeScript, React.js, Redux, tailwindcss](https://skillicons.dev/icons?i=next,nodejs,js,ts,react,redux, tailwindcss)](https://skillicons.dev)
